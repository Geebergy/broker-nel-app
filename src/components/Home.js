...
const CustomLink = ({ to, children, ...props }) => {
  ...
  return (
   ...
   <ToastContainer />
    <div className=' home-container'>
      ...
      <div style={boxStyle} className='border-top-theme tt-Box'>
        ...
        (<>
          ...
          <img src={userData.avatar} style={avatar} className='img-fluid d-block mx-1'/><h3 style={userStyle} className='text-end'>{userData.fullName}</h3>
        </div>
        {/* first row */}
    <div className='row'>
      <div className='col-6'>
          <div className="card bg-secondary" style={accBox}>
            <div className="card-body">
              ...
              {loading ? spinner : (
                    <p className="card-text display-6" style={smaller}>
                      <FeeItem amountInUSD={userData.balance || 0} />
                      {currencySymbol}
                    </p>
                  )}
            </div>
      ...
      <div className='col-6'>
          <div className="card bg-secondary" style={accBox}>
            <div className="card-body">
              ...
              {loading ? spinner : (
                    <p className="card-text display-6" style={smaller}>
                      <FeeItem amountInUSD={userData.returns || 0} />
                      {currencySymbol}
                    </p>
                  )}
            </div>
      ...
      <div className='col-6'>
          <div className="card bg-secondary" style={accBox}>
            <div className="card-body">
              ...
              {loading ? spinner : (
                    <p className="card-text display-6" style={smaller}>
                      <FeeItem amountInUSD={userData.deposit || 0} />
                      {currencySymbol}
                    </p>
                  )}
            </div>
      ...
      <div className='col-6'>
          <div className="card bg-secondary" style={accBox}>
            <div className="card-body">
              ...
              {loading ? spinner : (
                    <p className="card-text display-6" style={smaller}>
                      <FeeItem amountInUSD={userData.referralsBalance || 0} />
                      {currencySymbol}
                    </p>
                  )}
            </div>
    ...
    {/* end of task box */}
    <div className='moreOptions border-top-theme mt-5 text-white p-4' style={moreOptions}>
        <>
        <h5>More options</h5>
      <div className='row'>
